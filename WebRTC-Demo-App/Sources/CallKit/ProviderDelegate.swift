...
final class ProviderDelegate: NSObject, ObservableObject {
    ...
    static let providerConfiguration: CXProviderConfiguration = {
        let providerConfiguration = CXProviderConfiguration(localizedName: "name")
...
extension ProviderDelegate: CXProviderDelegate {
    ...
    func provider(_ provider: CXProvider, perform action: CXStartCallAction) {
        ...
        call.muteDidChange = { mute in
            print("mute Change: \(mute)")
            CallController.shared.muteAudio(mute)
        }
    ...
    func provider(_ provider: CXProvider, perform action: CXSetHeldCallAction) {
        ...
        print("isOnHold: \(action.isOnHold)")
    ...
    func provider(_ provider: CXProvider, perform action: CXSetMutedCallAction) {
        ...
        print("isMute action:\(action.isMuted)")
    ...
    func provider(_ provider: CXProvider, didActivate audioSession: AVAudioSession) {
        ...
        /*
         ...
         after having its priority elevated.
         */
        AudioSession.shared.useMunualAudio = true
        AudioSession.shared.isAudioEnabled = true
        AudioSession.shared.didActivate(audioSession)
    }

    func provider(_ provider: CXProvider, didDeactivate audioSession: AVAudioSession) {
        print("Received", #function)
        AudioSession.shared.didDeactivate(audioSession)
        AudioSession.shared.isAudioEnabled = false
...
func startAudio() {
    print("Start audio")
    CallController.shared.muteAudio(false)
}

func stopAudio() {
    print("Stop audio")
    CallController.shared.muteAudio(true)
}
